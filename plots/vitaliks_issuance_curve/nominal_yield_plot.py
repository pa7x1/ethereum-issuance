...
nominal_issuance_yield = percentage_yield(vitaliks_issuance_yield(x))
...
plt.title("Vitalik's Stake Capping Nominal Yield")
...
plt.show()
fig.savefig('./vitalik_nominal_yield_plot.png', dpi=fig.dpi)