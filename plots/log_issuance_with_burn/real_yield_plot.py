...
real_staking_yield_solo = percentage_yield(real_issuance_yield(issuance_yield=log_issuance_with_burn_yield(x),
                                                               ...
                                                               staked=x,
                                                               **home_staking))
real_staking_yield_lst = percentage_yield(real_issuance_yield(issuance_yield=log_issuance_with_burn_yield(x),
                                                              supply=CIRCULATING_SUPPLY,
                                                              staked=x,
                                                              **lst_staking))
real_staking_yield_institutional = percentage_yield(
    real_issuance_yield(issuance_yield=log_issuance_with_burn_yield(x),
                        supply=CIRCULATING_SUPPLY,
                        staked=x,
