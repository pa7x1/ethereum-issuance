...
issuance_plot = issuance(vitaliks_issuance_yield, x) / CIRCULATING_SUPPLY
...
plt.title("Vitalik's Stake Capping Issuance")
...
plt.show()
fig.savefig('./vitalik_issuance_plot.png', dpi=fig.dpi)