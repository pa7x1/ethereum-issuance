...
nominal_issuance_yield = percentage_yield(tempered_issuance(x))
...
plt.title("Tempered Issuance Nominal Yield")
...
plt.show()
fig.savefig('./tempered_issuance_nominal_yield_plot.png', dpi=fig.dpi)