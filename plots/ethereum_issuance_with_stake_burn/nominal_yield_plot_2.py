...
import numpy as np
from yield_curves import ethereum_issuance_with_burn_2_yield
...
nominal_issuance_yield = percentage_yield(ethereum_issuance_with_burn_2_yield(x))
...
plt.show()
fig.savefig('./ethereum_nominal_yield_with_burn_2_plot.png', dpi=fig.dpi)